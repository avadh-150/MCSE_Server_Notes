...
To transfer the  **RID Master** FSMO roles to an **Additional Domain Controller (ADC)** . follow this step-by-step :

OPEN .... **Active Directory Users and Computers** console.

1. **Open the Console:** In Server Manager, click **Tools** and select **Active Directory Users and Computers**.
...
2. **Connect to the ADC:**
    ...
    - Right-click the top-level node (e.g., **Active Directory Users and Computers [DC.forward.in]**) and select **Change Domain Controller...**.
...
3. **Initiate the Transfer:**
    ...
    - A success message will confirm: "The operations master role was successfully transferred".
		...
		![image](https://github.com/avadh-150/MCSE_Server_Notes/blob/main/MCSE%20Class%20Notes/img/FSMO/6.png?raw=true)
